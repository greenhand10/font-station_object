      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="cartInfo in  cartInfoList" :key="cartInfo.id">
          ...
          <li class="cart-list-con5">
            ...
            <input autocomplete="off" type="text" minnum="1" class="itxt" :value="cartInfo.skuNum" @change="handler('change',$event.target.value*1,cartInfo)">
  ...
  export default {
    ...
    methods:{
      ...
      async updateChecked(cart,event){
        ...
        // 这个显示的是布尔值但是后端设置的是0和1，因此需要对这个数据进行修改
        try {
          //如果修改数据成功，再次获取服务器的数据（购物车）
    ...
    computed:{
      ...
      //判断是否所有的isChecked是否都是一 为全选选项做准备
      isAllChecked(){
