          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="item in spuSaleAttrList" :key="item.id">
                ...
                <dd changepirce="0" :class="{active:item2.isChecked == 1}" v-for="item2 in item.spuSaleAttrValueList" :key="item2.id" @click="changActive(item2,item.spuSaleAttrValueList)">{{item2.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="skuNum" @change="skuNumChange">
                <a href="javascript:" class="plus" @click="skuNum++">+</a>
                <a href="javascript:" class="mins" @click="skuNum>1?skuNum--:skuNum=1">-</a>
              </div>
              <div class="add">
                <a href="javascript:" @click="addToShoppingCar">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
